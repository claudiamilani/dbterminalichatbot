...
@section('content')
    <div class="row">
        @component('components.widget',['size' => 8])
            @slot('title')
                @lang('DBT/attr_categories.edit.title')
            @endslot
            @slot('body')
                {!! Form::model($attr_category,['route' => ['admin::dbt.attr_categories.update',paramsWithBackTo($attr_category->id)],'class' => 'form-horizontal', 'method'=>'PATCH']) !!}
                <div class="form-group">
                    <div class="col-md-12">
                        <input type="hidden" name="published" value="0">
                        {!! Form::checkbox('published', 1, null, [ 'id' => 'published','class' => 'form-control', 'data-toggle' => 'toggle', 'data-size' => 'mini', 'data-on' => trans('common.published'), 'data-off' => trans('common.unpublished'), 'data-onstyle' => 'success pull-right', 'data-offstyle' => 'danger pull-right', 'data-style' => 'android mdl-large']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::textarea('description',null, ['id' => 'description', 'class' => 'form-control height-md noResize required']) !!}
                    </div>
                </div>
