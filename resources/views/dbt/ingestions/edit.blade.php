...
@section('content')
    <div class="row">
        @component('components.widget', ['size' => 8, 'hide_required_legend'=>true])
            @slot('title')
                @lang('DBT/ingestions.edit.title')
            @endslot
            @slot('body')
                {!! Form::model($ingestion,['route' => ['admin::dbt.ingestions.update',paramsWithBackTo($ingestion->id)], 'method'=>'PATCH','class' => 'form-horizontal', 'files'=>true]) !!}
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-6">
                        {!! Form::file('file_path',  ['class' => 'form-control', 'id' => 'file_path']) !!}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('notify_mails[]',$notify_mails,is_array($notify_mails) ? array_keys($notify_mails) : [],['class' => 'form-control', 'id' => 'notify_mails', 'multiple']) !!}
                    </div>
                </div>
                <div class="form-group">
            ...
            @slot('footer')
                <div class="btn-toolbar pull-right">
                    ...
                    <button type="submit" class=" btn btn-md btn-primary"><i
                                class="fas fa-fw fa-save"></i> @lang('common.form.save')</button>
                </div>
                {!! Form::close() !!}
            @endslot
        @endcomponent
