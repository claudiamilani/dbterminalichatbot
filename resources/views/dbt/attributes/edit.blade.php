...
@section('content')
    <div class="row">
        @component('components.widget',['size' => 8])
            @slot('title')
                @lang('DBT/attributes.edit.title')
            @endslot
            @slot('body')
                {!! Form::model($attribute,['route' => ['admin::dbt.attributes.update',paramsWithBackTo($attribute->id)],'class' => 'form-horizontal', 'method'=>'PATCH']) !!}
                <div class="form-group">
                    <div class="col-md-12">
                        <input type="hidden" name="published" value="0">
                        {!! Form::checkbox('published', 1, $attribute->published, [ 'id' => 'published','class' => 'form-control', 'data-toggle' => 'toggle', 'data-size' => 'mini', 'data-on' => trans('common.published'), 'data-off' => trans('common.unpublished'), 'data-onstyle' => 'success pull-right', 'data-offstyle' => 'danger pull-right', 'data-style' => 'android mdl-large']) !!}
                    </div>
                </div>
                @if($attribute->ingestion_id)
                    <div class="form-group">
                        <label for="ingestion_source_id"
                               class="col-md-3 control-label">@lang('DBT/attributes.attributes.ingestion_source_id')</label>
                        <div class="col-md-9">
                            <p class="form-control-static">{{$attribute->ingestionSource->name}}</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ingestion_id"
                               class="col-md-3 control-label">@lang('DBT/attributes.attributes.ingestion_id')</label>
                        <div class="col-md-9">
                            <p class="form-control-static">{{$attribute->ingestion->id}}</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('attr_category_id',$category ?? [] ,null, [ 'id' => 'attr_category_id','class' => 'form-control','required']) !!}
                    </div>
                </div>
                <div class="form-group">
                ...
                <fieldset>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('type', $types, null,[ 'id' => 'type','class' => 'form-control','required', $block_update_type ? 'disabled' : '', 'title'=> $block_update_type ? trans('DBT/attributes.edit.partial.success') : '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('input_type', $input_types, $attribute->getInputTypeOption(), [ 'id' => 'input_type','class' => 'form-control', $block_update_type ? 'disabled' : '','title'=> $block_update_type ? trans('DBT/attributes.edit.partial.success') : '']) !!}
                        </div>
                        <label for="input_type"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            ...
                            {!! Form::checkbox('required', 1, $attribute->getRequiredOption(), ['id' => 'required', 'class' => 'form-control type_option_check']) !!}
                        </div>
                        <label for="multiple"
                               class="col-md-3 control-label">@lang('DBT/attributes.type_options.multiple')</label>
                        <div class="col-md-1">
                            <input type="hidden" name="multiple" value="0">
                            {!! Form::checkbox('multiple', 1, $attribute->getMultipleOption(), ['id' => 'multiple', 'class' => 'form-control type_option_check']) !!}
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            {!! Form::checkbox('searchable', 1, $attribute->getSearchableOption(), ['id' => 'searchable', 'class' => 'form-control type_option_check']) !!}
                        </div>
                    ...
                    <div class="form-group " id="options_div">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('options[]', $attribute->getOptions()   ,$attribute->getOptions(), [ 'id' => 'options','class' => 'form-control', 'multiple']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="default_value_div">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('default_value[]',$attribute->getDefaultValueOptions(),$attribute->getDefaultValue(), ['id' => 'default_value', 'class' => 'form-control', 'multiple' ]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="default_bool_div">
                        <label for="default_value_bool"
                               class="col-md-3 control-label">@lang('DBT/attributes.attributes.default_value')</label>
                        <div class="col-md-9">
                            {!! Form::select('default_bool_value',['0'=>'False','1'=>'True'],$attribute->getDefaultValue(), ['id' => 'default_bool_value', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </fieldset>
            @endslot
...
@push('scripts')
    ...
    @component('components.select2_script', ['name' => 'options[]', 'route' => route('admin::dbt.attributes.select2TypeOptions'), 'tags'=>true, 'minChars'=>1,'inputTooShort'=>trans('DBT/attributes.input_too_short')])
        ...
        @endslot
    @endcomponent
    @component('components.select2_script', ['name' => 'default_value[]', 'route' => route('admin::dbt.attributes.select2TypeOptions'), 'tags'=>true,'inputTooShort'=> trans('DBT/attributes.empty_default_value'), 'minChars'=>1])
        @slot('dataParams')
