@component('components.modal')
    ...
    @endslot
    @slot('title')
        @lang('user_sessions.purge.title_auth')
    @endslot
    @slot('content')
        <p>@lang('user_sessions.purge.confirm_msg_auth')</p>
        {!! Form::open(['route' => ['admin::user_sessions.destroySessions','authenticated'], 'method' => 'delete', 'class' => 'form-horizontal', 'style' => 'padding: 15px 15px 0 15px']) !!}
